...
export const HeroSection = () => {
    return(
        <section className=" hero bg-custom-yellow px-20 relative ">
            <svg width="491" height="580" viewBox="0 0 491 682" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-4 left-5 ">
            ...
            <svg width="1200" height="780" viewBox="0 0 1287 972" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute -top-12 right-16 z-0">
            ...
            <h1 className="text-center font-bold text-8xl py-32 z-10">Let’s create something <br /> great together.</h1>
            <div className="flex items-center justify-around ">
                <img src={HandImage1} alt="" className="w-52 z-20"/>
                <img src={HandImage2} alt="" className="w-52 z-20"/>
                <img src={HandImage3} alt="" className="w-52 z-20"/>
                <img src={HandImage4} alt="" className="w-52 z-20"/>
                <img src={HandImage5} alt="" className="w-52 z-20"/>
                <img src={HandImage6} alt="" className="w-52 z-20"/>
            </div>
        </section>
    );
}